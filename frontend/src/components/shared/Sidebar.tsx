...
const navItems = [
  ...
  { name: 'Form O (Mines Rules)', href: '/ohs/form-o', icon: Activity, roles: ['admin', 'doctor', 'staff'] },
  { name: 'Form 32 (Dangerous Ops)', href: '/ohs/form-32', icon: ShieldAlert, roles: ['admin', 'doctor', 'staff'] },
  { name: 'Form 21 Health Register', href: '/ohs/form-21', icon: Users, roles: ['admin', 'doctor', 'staff'] },
